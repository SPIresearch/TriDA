...
def get_model(model_name, pretrain=True, pretrained_checkpoint=None):
    if model_name in models.__dict__:
        # load models from tllib.vision.models
        backbone = models.__dict__[model_name](pretrained=False)
    else:
        # load models from pytorch-image-models
        backbone = timm.create_model(model_name, pretrained=False, checkpoint_path=pretrained_checkpoint)
        try:
