...
class Fc_cls(nn.Module):
    def __init__(self, in_features, num_classes=1000):
        ...
        pth = torch.load('resnet50-19c8e357.pth')
        state_dict = {'weight': pth["fc.weight"], 'bias':pth["fc.bias"]}
...
class ResBase(nn.Module):
    def __init__(self, res_name):
        ...
        model_resnet = res_dict[res_name](pretrained=None)
        if res_name == "resnet50":
            weight = 'resnet50-19c8e357.pth'
        elif res_name =='resnet101':
            weight = 'resnet101-63fe2227.pth'
        else:
            weight = None
        model_resnet.load_state_dict(torch.load(weight))
